...
public class CreateRecordsExample {
    ...
    private static void insertUser(User user) throws SQLException {
        ...
        try {
            ...
            //stmt.setInt(5, user.getRating().ordinal());
            stmt.setObject(5, user.getRating().ordinal());

            stmt.setString( 6, user.getImportantValue() );

            stmt.setString( 7, user.userAddress.getCountry() );
            stmt.setString( 8, user.userAddress.getCity() );
            stmt.setString( 9, user.userAddress.getStreet() );
            stmt.setString( 10, user.userAddress.getHome() );
    ...
    private static void initDb() throws SQLException {
        ...
        try {
            ...
            stmt = conn.prepareStatement( "CREATE TABLE User(id INT PRIMARY KEY, name VARCHAR(70), "
